    ...
    >
      ...
      <div className="text-center text-yellow-400 p-8">
        ...
        <p className="text-sm text-gray-400 mb-4">
          Funding rate monitoring requires CoinGlass Professional+ plan for real-time data access.
        </p>
        ...
        <div className="mt-6 bg-gray-700 rounded-lg p-4">
          <h4 className="text-sm font-semibold text-pink-400 mb-2">Alternative Analysis Available:</h4>
          <p className="text-xs text-gray-300">
            • Real-time price action analysis<br/>
            • Volume-based sentiment indicators<br/>
            • Market cap behavior patterns<br/>
